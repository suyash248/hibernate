...
public class Save
{
	public static void main(String... w)
	{
		...
		try
		{
			...
			session.save(ct2);
			session.save(ct3); */
			// Code for selecting multiple rows via HQL.
			String hql="from Contact con where con.firstName=? and con.lastName=?";
			Query q=session.createQuery(hql);	// using HQL so here "Contact" is our POJO class.
			q.setString(0,"Abhi");
			q.setString(1,"Soni");
			List list=q.list();
